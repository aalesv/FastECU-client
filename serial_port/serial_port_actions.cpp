...
bool SerialPortActions::get_add_ssm_header()
{
...
uint8_t SerialPortActions::get_kline_startbyte()
{
...
uint8_t SerialPortActions::get_kline_tester_id()
{
...
uint8_t SerialPortActions::get_kline_target_id()
{
